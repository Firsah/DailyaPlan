    ...
    <div class="judul">Ruang Perencanaan</div>
        <div class="content">
             <div class="card">
                ...
                <a id="isi-card-click" href="#">
                <div class="isi-card">
                    <div class="nama-host">Danu yasa</div>
                    <div class="posisi-host">ADV</div>
                    <div class="judul-card">Ruang Analisa Produk Baru</div>
                    <div class="status">
            ...
            <div class="card">
                ...
                <div class="isi-menu-card">
                    <ul>
                        <li><i class="fa-regular fa-pen-to-square fa-sm" style="color: #9c9c9a;" id="icon-menu-card"></i><a href="#">Ubah</a></li>
                        <li><i class="fa-regular fa-eye fa-sm" style="color: #9C9C9A;" id="icon-menu-card"></i><a href="#">Hak Akses</a></li>
                        <li><i class="fa-regular fa-user fa-sm" style="color: #9C9C9A;"  id="icon-menu-card"></i><a href="#">Detail Anggota</a></li>
                        <li><i class="fa-regular fa-trash-can fa-sm" style="color: #9C9C9A;" id="icon-menu-card"></i><a href="#">Hapus</a></li>
                    </ul>
                </div>
                <a id="isi-card-click" href="#">
        ...
        <div class="modal-tambah-ruangan">
            ...
            <div class="content-mtr">
               <form action="" method="post">
                <div class="cont">
                    <label for="">Judul<span style="color: #CB2027;">*</span></label>
                    <input type="text" name="#" id="#" placeholder="Input Judul">
                </div>

                <div class="cont">
                    <label>Goal<span style="color: #CB2027;">*</span></label>
				    <textarea name="" id="" rows="2" placeholder="Input Goal"></textarea>
                </div>
